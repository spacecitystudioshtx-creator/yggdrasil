...
const BOSS_PATTERNS: Record<string, ProjectilePattern> = {
  ...
  // --- Fenrir (World Boss) patterns ---
  fenrir_spiral: {
    patternId: 'fenrir_spiral',
    type: BulletPatternType.Spiral,
    projectileCount: 16,
    projectileSpeed: 170,
    projectileDamage: -1, // sentinel: 10% player max HP
    projectileLifetime: 3.5,
    projectileSize: 4,
    spreadAngle: 360,
    rotationSpeed: 60,
  ...
  fenrir_double_spiral: {
    patternId: 'fenrir_double_spiral',
    type: BulletPatternType.Spiral,
    projectileCount: 12,
    projectileSpeed: 200,
    projectileDamage: -1,
  ...
  fenrir_radial_berserk: {
    patternId: 'fenrir_radial_berserk',
    type: BulletPatternType.Radial,
    projectileCount: 20,
    projectileSpeed: 230,
    projectileDamage: -1,
...
// ============================================================================
// Fenrir — World Boss Definition (used by GameScene)
// ============================================================================

export const FENRIR_BOSS_DEF: DungeonBossDef = {
  name: 'FENRIR  —  THE WORLD ENDER',
  ...
  phases: [
    {
      healthThreshold: 1.0,
      phaseName: 'The Wolf Stirs',
      dialogue: 'The chains of the gods could not hold me...',
      patternIds: ['fenrir_spiral'],
      spawnEnemyIds: [],
      speedMultiplier: 1.0,
    ...
    {
      healthThreshold: 0.5,
      phaseName: 'Rage of Fenrir',
      dialogue: 'I WILL SWALLOW THE SUN!',
      patternIds: ['fenrir_double_spiral', 'fenrir_aimed'],
      spawnEnemyIds: [],
    ...
    },
    {
      healthThreshold: 0.2,
      phaseName: 'Ragnarök',
      dialogue: 'THIS IS THE END OF ALL THINGS!',
      patternIds: ['fenrir_radial_berserk', 'fenrir_aimed', 'fenrir_burst'],
      spawnEnemyIds: [],
      speedMultiplier: 1.8,
  ...
  patterns: {
    fenrir_spiral: BOSS_PATTERNS.fenrir_spiral,
    fenrir_double_spiral: BOSS_PATTERNS.fenrir_double_spiral,
    fenrir_aimed: BOSS_PATTERNS.fenrir_aimed,
    fenrir_radial_berserk: BOSS_PATTERNS.fenrir_radial_berserk,
    fenrir_burst: BOSS_PATTERNS.fenrir_burst,
  },
  loot: [],
};
